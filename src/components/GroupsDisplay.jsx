...
import { usechatTypeStore } from "../../backend/store/chatTypeStore.js";
            ...
            >
              ...
              <div className="mt-2">
                ...
                <p className="text-xs text-gray-500">
                  Admin:{" "}
                  {gpchat.members.find((member) => member.role === "admin")
                    ?.email || gpchat.createdBy}
                </p>
              </div>
                ...
                <div className="mt-3">
                  ...
                  <div className="mt-1">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      {new Date(
                        gpchat.lastgroupMessage.createdAt
                      ).toLocaleString()}
                    </p>
                  </div>
                </div>
